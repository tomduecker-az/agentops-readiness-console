...
**Pitch:** Turns scattered access request data into a reviewer-ready briefing without making the access decision.
...
An Identity Analyst opens a request that is close to routing and needs to know whether it is ready for approval review.

**Before:**

The analyst checks verification status, role mapping, approval state, security-review triggers, evidence references, and SLA risk across multiple systems.

**After:**

The assistant presents a single briefing that shows what is ready, what is missing, which review is required, and what human action should happen next.

**Sample assistant output:**

- **Request readiness:** Not ready for approval routing
- **Reason:** Role mapping is missing and verification status is unresolved
- **Required next action:** Identity Analyst clarification
- **Security review:** Cannot determine until role mapping is resolved
- **Evidence gap:** Approval evidence reference is not present

**What AI does:**

- Summarizes approved normalized and derived fields
- Highlights missing or conflicting request information
- Assembles a reviewer-ready briefing
- Explains why a request is ready, blocked, or needs clarification

**What AI does not do:**

- Approve or reject access
- Provision access
- Update tickets or systems of record
- Send clarification or escalation messages
- Suppress required security review

**Demo moment:**

Show two requests side by side: one ready for review and one blocked. The copilot explains the difference in seconds.
